...
#include "cs_register_pressure__clang.h"
...
CS_register_pressure_Clang::CS_register_pressure_Clang()
{
}

bool CS_register_pressure_Clang::prepare(const vkb::ApplicationOptions &options)
{
...
std::unique_ptr<vkb::VulkanSampleC> create_cs_register_pressure__clang()
{
	return std::make_unique<CS_register_pressure_Clang>();
}
